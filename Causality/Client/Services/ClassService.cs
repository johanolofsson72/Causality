...
namespace Causality.Client.Services
{
    ...
    { 
        ...
        /// <returns></returns>
        public async Task TryGet(Expression<Func<Class, bool>> filter, string orderby, bool ascending, string includeProperties, Func<IEnumerable<Class>, string, Task> onSuccess, Func<Exception, string, Task> onFail, CascadingAppStateProvider state)
        {
            try
            {
        ...
        /// <param name="state"></param>
        /// <returns></returns>
        public async Task TryGetById(int id, string includeProperties, Func<Class, string, Task> onSuccess, Func<Exception, string, Task> onFail, CascadingAppStateProvider state)
        {
            try
            {
        ...
        public async Task TryInsert(Class Class, Func<Class, string, Task> onSuccess, Func<Exception, string, Task> onFail, CascadingAppStateProvider state)
        {
            try
            {
                string status = "";
                ...
                if(onSuccess is not null) await onSuccess(Class, status);
        ...
        public async Task TryUpdate(Class Class, Func<Class, string, Task> onSuccess, Func<Exception, string, Task> onFail, CascadingAppStateProvider state)
        {
            try
            {
                string status = "";
