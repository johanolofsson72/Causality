...
namespace Causality.Client.Services
{
    public class StateService
    {
        ...
        /// <returns></returns>
        public async Task TryGet(Expression<Func<State, bool>> filter, string orderby, bool ascending, string includeProperties, Func<IEnumerable<State>, string, Task> onSuccess, Func<Exception, string, Task> onFail, CascadingAppStateProvider state)
        {
            try
            {
        ...
        /// <param name="state"></param>
        /// <returns></returns>
        public async Task TryGetById(int id, string includeProperties, Func<State, string, Task> onSuccess, Func<Exception, string, Task> onFail, CascadingAppStateProvider state)
        {
            try
            {
        ...
        public async Task TryInsert(State State, Func<State, string, Task> onSuccess, Func<Exception, string, Task> onFail, CascadingAppStateProvider state)
        {
            try
            {
                string status = "";
                ...
                if(onSuccess is not null) await onSuccess(State, status);
        ...
        public async Task TryUpdate(State State, Func<State, string, Task> onSuccess, Func<Exception, string, Task> onFail, CascadingAppStateProvider state)
        {
            try
            {
                string status = "";
